...
Bei der Anbindung von Industrie, Gewerbe und Handel gibt es Handlungsbedarf. Die Verzahnung des bereits bestehenden ÖPNV Angebotes muss diverser, effizienter und effektiver gestaltet werden.
...
Die Außenbezirke sind häufig stark auf einzelne Linien angewiesen und eine Abhängigkeit in ein Medium entsteht. Die Vernetzung unterschiedlicher Verkehrsmittel ist einer der Schlüssel zur Gestaltung der Verkehrswende in Berlin. ​
...
Denn die Dichte bestimmt maßgeblich das zu erwartende Volumen an möglichen Fahrgästen oder Nutzern in den entsprechenden Regionen. Denn großflächige Handels-, Gewerbe- oder Industriegebiete können durch einen hohen automatisierungsgrad sehr gering ausfallen.
...
Diese fehlenden Metriken bzw. Segmente würden eine ganzheitliche Betrachtung des Straßenverkehrs ermöglichen und helfen dabei vollständiges Bild zeichnen. Das schließen dieser Lücken mit verschiednene Methoden wie Minimum, Durschnitt, Maximum etc. hätte einzig nur die Daten vervollständigt aber nicht die Qualität erhöht sonder eher reduziert.
...
Gründsätzlich wurden Wasserflächen nicht vollständig betrachtet. Darunter zählen Entitäten wie Hausboote, gewerbliche Flächen und Verkehrsmittel auf dem Wasser. Die BVG betreibt zwei Fähren und auf dem Müggelsee gibt es zahlreiche Hausboote und vereinzelt Gewerbeflächen auf dem Wasser.
\todo[inline]{QUELLE FINDEN ZU DEN FÄHREN !!! \% vielleicht auch zu den Gewerbeflächen}

\todo[inline]{MEHR !!! \% mehr Inhalt zur Anreicherung}

\subsubsection{Komplexität der Analyse}
Die Dimension der Taktung des ÖPNV wird in der Analyse nicht berücksichtigt​. Wie bereits erwähnt, ist nicht nur die Auslastung sondern auch die Taktung für eine ganzheitliche Betrachtung essenziell.
\todo[inline]{AUSLASTUNG beschreiben !!! \% Huch ich muss die nächste Bahn nehmen weil alles voll ist!!}
Wie bei der Verkehrsanalyse der Straße, in Kapitel \ref{projektergebnisse}, könnte hier auch zu gewissen Zeiten ein Peek entstehen und das Verkehrsmittel so auslasten das 
\todo[inline]{AUSLASTUNG beschreiben !!! \% Huch ich muss die nächste Bahn nehmen weil alles voll ist!!}
\todo[inline]{REFERENZ funktioniert nicht}
