...
Im vorliegenden Bericht werden die Ergebnisse des Projekts \enquote{Berlin Mobility - Verkehrsanalyse im Raum Berlin} vorgestellt. Das Projekt wurde zwischen Oktober 2020 und Februar 2021 durchgeführt. Als fiktiver Auftraggeber hat die Berliner \ac{SenUVK} gedient. Die behandelte Problemstellung adressiert dabei reelle Anforderungen der \ac{SenUVK}, welche sich aus dem \ac{MobG BE} vom 5. Juli 2008 ergeben.
...
Die erzielten Analyseergebnisse werden in Form einer Webapplikation aufbereitet, welche darüber hinaus ein interaktives Mobilitäts-Dashboard beinhaltet. Mit der Aufbereitung werden zwei Ziele verfolgt. Zum einen soll die visuell anspruchsvolle Darstellung der Analyseergebnisse einen niedrigschwelligen Zugang bieten, welcher in der Bürger*innen-Kommunikation eingesetzt werden kann. Zum anderen soll das interaktive Mobilitäts-Dashboard weiterführende (Verkehrs-)Analysen ermöglichen. Das Mobilitäts-Dashboard wird als Prototyp umgesetzt, der in ein Planungstool für Mobilitätsmaßnahmen weiterentwickelt werden kann.
