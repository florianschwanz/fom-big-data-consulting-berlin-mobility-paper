...
\emph{Firebase}\footnote{https://firebase.google.com/} bietet als sogenanntes Backend-as-a-Service (BaaS)\todo[inline]{BaaS ggf. in Glossar? und in acc} die Möglichkeit, Datenbanken und Webhosting als Dienstleistung zu nutzen, ohne eine dedizierte Infrastruktur aufsetzen zu müssen, wodurch es sich insbesondere für Experimente und Prototypen eignet. Firebasis wird für das hosting der im Rahmen des Projekts entwickelten Webapplikation verwendet.
...
\todo[inline]{wenn wir noch Zeit haben: Hier und im Ergebniskapitel den Personaansatz noch einarbeiten. Den hatte er im Rahmen der Präsentation explizit hervorgehoben} 
