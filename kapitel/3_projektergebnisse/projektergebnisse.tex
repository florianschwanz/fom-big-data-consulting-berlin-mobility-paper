...
\img{karte_einwohnerdichte}{karte_einwohnerdichte.png}{width=14cm}{Verteilung der Einwohnerdichte und die 3 Flächen mit der höchsten Bevölkerungsdichte: Mariendorf, Tempelhof und Kaulsdorf-Mahlsdorf}
...
\img{karte_arbeitsplätze}{karte_arbeitsplätze.png}{width=14cm}{Verteilung der Arbeitsplätze, Bildungseinrichtungen und Einkaufsmöglichkeiten}
...
\img{karte_strassen}{karte_strassen.png}{width=14cm}{Verteilung der zulässigen Höchstgeschwindigkeiten im Berliner Straßennetz}
...
\img{tatsächlich_speed}{tatsächlich_speed.png}{width=14cm}{Verteilung der tatsächlich gefahrenen Höchstgeschwindigkeiten im Tagesverlauf an Wochentagen}
...
\img{karte_radnetz}{karte_radnetz.png}{width=14cm}{Verteilung dedizierter Radverkehrsanlagen im Berliner Straßennetz; eingefärbt nach Länge des Segments}
...
Als besondere Herausforderung für den Verkehr in Charlottenburg-Nord gilt der Ausbau des ehemaligen Flughafens TXL zum Innovations- und Entwicklungsstandort. Durch die große Anzahl neuer Arbeitsplätze, die hier entstehen sollen, wird prognostiziert, dass das Verkehrsaufkommen merklich steigen wird.\todo[inline]{Quelle für die Arbeitsplatzprognose} Aufgrund der Begrenzung durch den Berlin-Spandauer-Schifffahrtskanal im Norden und Osten sowie durch den Westhafenkanal im Süden gestaltet sich die Anbindung an die vorhandene Verkehrsinfrastruktur in angrenzenden Gebieten als schwierig.
